...
interface MeetuppostProps {}

const Meetuppost: FC<MeetuppostProps> = ({}) => {
  return (
    <div className="w-full h-max max-w-[728px] flex flex-col rounded-sm overflow-hidden border">
      ...
      <div className="flex w-full justify-start items-center m-4">
        <p className="font-semibold">🗓️ Meetup</p>
      </div>
      ...
      <div className="m-4 w-[calc(100%-32px)] mt-0 flex justify-between lg:justify-start items-center lg:gap-x-8">
        <div className="flex justify-center items-center">
            ...
            <p className="truncate text-ellipsis">Fri, 12 Oct, 2018</p>
        </div>
        <div className="flex justify-center items-center">
            <Image src={location} alt="location" className="w-[20px] h-[20px]"/>
            <p className="truncate text-ellipsis">Ahmedabad, India</p>
        </div>
      </div>
      <button className="m-4 mt-0 w-[calc(100%-32px)] bg-white text-[#E56135] border border-[#A9AEB8] text-center py-1.5 rounded-lg font-semibold">Visit Website</button>
